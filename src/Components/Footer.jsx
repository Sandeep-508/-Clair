...
const Footer = () => {
    ...
    return (
        <div className='bg-black -mt-2px' style={footer_back_img}>
            <div className='scroll_top' onClick={scroll_top} style={{ display: visible ? "grid" : "none" }}>
            ...
            <div className="container_hero">
                ...
                <div className='d-flex align-items-center justify-content-center'>
                    <div className='overflow-x-auto d-flex align-items-center justify-content-start gap-media-nav-link' style={{ width: '768px', marginBottom: '40px' }}>
                        ...
                        <a href="#" className='fm fw-semibold fs-16 lh-24 footer-link' style={{ color: '#D9D9D9' }}>Tokenomics</a>
                        <a href="#" className='fm fw-semibold fs-16 lh-24 footer-link' style={{ color: '#D9D9D9' }}>Audit</a>
                        <a href="#" className='fm fw-semibold fs-16 lh-24 footer-link' style={{ color: '#D9D9D9' }}>Roadmap</a>
                        <a href="#" className='fm fw-semibold fs-16 lh-24 footer-link' style={{ color: '#D9D9D9' }}>WhitePaper</a>
